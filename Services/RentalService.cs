...
// Handles all rental business logic: users, rentals, limits
public class RentalService : IRentalService
{
    ...
    // Blocks rental if item is taken or user hit their limit
    ...
    // Calculates penalty and closes the rental
    ...
    // Used to manually register a rental - bypasses normal flow
